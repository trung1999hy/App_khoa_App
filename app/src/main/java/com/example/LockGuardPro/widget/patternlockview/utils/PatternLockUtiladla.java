package com.example.LockGuardPro.widget.patternlockview.utils;
...
public class PatternLockUtiladla {

    private static final String UTF8 = "UTF-8";
    private static final String SHA1 = "SHA-1";
    private static final String MD5 = "MD5";

    private PatternLockUtiladla() {
    ...
    public static ArrayList<PatternLockView.Dot> generateRandomPattern(PatternLockView patternLockView,
        ...
        int lastId = RandomUtilswiww.randInt(patternLockView.getDotCount());
        usedIds.add(lastId);
        ...
        while (usedIds.size() < size) {
            ...
            for (int distance = 1; distance <= maxDistance; distance++) {
                ...
                final int[] lines = RandomUtilswiww.randIntArray(4);
                for (int line : lines) {
                    switch (line) {
                        case 0: {
                            if (rowA >= 0) {
                                randomValues = RandomUtilswiww.randIntArray(Math.max(0, colA),
                        ...
                        case 1: {
                            if (colC < patternLockView.getDotCount()) {
                                randomValues = RandomUtilswiww.randIntArray(Math.max(0, rowA + 1),
                                        Math.min(patternLockView.getDotCount(),
                                                rowC + 1));
