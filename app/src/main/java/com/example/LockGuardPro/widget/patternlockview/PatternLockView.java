package com.example.LockGuardPro.widget.patternlockview;
...
import com.example.LockGuardPro.widget.patternlockview.utils.Utils;
...
public class PatternLockView extends View {
    ...
    private List<PatternLockViewListenerqqq> mPatternListeners;
    ...
    public PatternLockView(Context context, AttributeSet attrs) {
        ...
        try {
            ...
            mPathWidth = (int) typedArray.getDimension(R.styleable.PatternLockView_pathWidth,
                    Utils.getDimensionInPx(getContext(), R.dimen.pattern_lock_path_width));
            mNormalStateColor = typedArray.getColor(R.styleable.PatternLockView_normalStateColor,
                    Utils.getColor(getContext(), R.color.gray));
            ...
            mWrongStateColor = typedArray.getColor(R.styleable.PatternLockView_wrongStateColor,
                    Utils.getColor(getContext(), R.color.pomegranate));
            mDotNormalSize = (int) typedArray.getDimension(R.styleable.PatternLockView_dotNormalSize,
                    Utils.getDimensionInPx(getContext(), R.dimen.pattern_lock_dot_size));
            mDotSelectedSize = (int) typedArray.getDimension(R.styleable
                            .PatternLockView_dotSelectedSize,
                    Utils.getDimensionInPx(getContext(), R.dimen.pattern_lock_dot_selected_size));
    ...
    protected Parcelable onSaveInstanceState() {
        ...
        return new SavedState(superState,
                PatternLockUtiladla.patternToString(this, mPattern),
    ...
    protected void onRestoreInstanceState(Parcelable state) {
        ...
        setPattern(PatternViewMode.CORRECT,
                PatternLockUtiladla.stringToPattern(this, savedState.getSerializedPattern()));
    ...
    public void addPatternLockListener(PatternLockViewListenerqqq patternListener) {
        mPatternListeners.add(patternListener);
    }

    public void removePatternLockListener(PatternLockViewListenerqqq patternListener) {
    ...
    private void notifyListenersStarted() {
        for (PatternLockViewListenerqqq patternListener : mPatternListeners) {
