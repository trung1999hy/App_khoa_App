package com.example.LockGuardPro.ui.inapp
...
class PurchaseInAppActivity : AppCompatActivity(), PurchaseInAppAdapter.OnClickListener {
    ...
    private val inAppProductList: ImmutableList<Product>
        private get() = ImmutableList.of( //Product 1
            Product.newBuilder().setProductId(Constants.KEY_5_COIN)
                .setProductType(ProductType.INAPP).build(),
            Product.newBuilder().setProductId(Constants.KEY_2_COIN)
                .setProductType(ProductType.INAPP).build(),
            Product.newBuilder().setProductId(Constants.KEY_10_COIN)
                .setProductType(ProductType.INAPP).build(),  //Product 2
            Product.newBuilder().setProductId(Constants.KEY_20_COIN)
                .setProductType(ProductType.INAPP).build(),  //Product 3
            Product.newBuilder().setProductId(Constants.KEY_50_COIN)
                .setProductType(ProductType.INAPP).build(),  //Product 4
            Product.newBuilder().setProductId(Constants.KEY_100_COIN)
                .setProductType(ProductType.INAPP).build(),  //Product 5
            Product.newBuilder().setProductId(Constants.KEY_150_COIN)
                .setProductType(ProductType.INAPP).build(),  //Product 6
            Product.newBuilder().setProductId(Constants.KEY_200_COIN)
                .setProductType(ProductType.INAPP).build(),
            Product.newBuilder().setProductId(Constants.KEY_300_COIN)
                .setProductType(ProductType.INAPP).build()
        )
